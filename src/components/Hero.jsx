        ...
        <div className="p-20 w-4/5 mx-auto flex justify-between">
            <div className="flex flex-col justify-between pr-20">
                <div className="flex items-center">
                    <hr className="w-[6.375rem] border-[#4338CA] mr-2" />
                    <p className="text-[#4338CA] text-xl font-medium">
                        Mert Öztürk
                    </p>
                </div>
                <h1 className="text-[#1F2937] font-bold text-6xl">
            ...
            <img className="rounded-xl w-3/6 my-10" src="../../public/hero.png" alt="" />
